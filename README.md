...
项目简介：MMKV 是基于 mmap 内存映射的 key-value 组件，底层序列化/反序列化使用 protobuf 实现，性能高，稳定性强，可以替代**SharedPreferences**
...
## 不再推荐
以下条目是因**更新时间过久**、**已停止维护**、**有更好替代品**等原因被推荐替换的项目 条目格式如下：
...
### ~~[MVP框架 MVPArms](https://github.com/JessYanCoding/MVPArms/wiki#1)~~
...
不推荐原因：官方推荐的MVVM架构，配合JetPack可以很轻松搭建MVVM架构

替代框架：使用[官方JetPack库](https://developer.android.google.cn/jetpack?hl=zh-cn)搭建MVVM架构
...
替代框架：[MagicIndicator](https://github.com/hackware1993/MagicIndicator)
