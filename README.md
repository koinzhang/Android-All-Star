...
项目简介：A modern JSON library for Kotlin and Java.

GitHub 🌟：7.2k

项目参考Blog：[新一代Json解析库Moshi使用及原理解析](https://juejin.cn/post/6844903704278073357)
...
项目简介：An Android library that makes developers use SQLite database extremely easy.

GitHub 🌟：7.6k

项目参考Blog：[Android数据库高手秘籍](https://blog.csdn.net/guolin_blog/category_9262963.html)

## 依赖注入

#### [dagger](https://github.com/google/dagger)

项目简介：A fast dependency injector for Android and Java.

GitHub 🌟：15.9k

项目参考Blog：[Dagger 2 完全解析（一），Dagger 2 的基本使用与原理](https://www.jianshu.com/p/26d9f99ea3bb)

#### [koin](https://github.com/InsertKoinIO/koin)

项目简介：Koin - a pragmatic lightweight dependency injection framework for Kotlin

GitHub 🌟：6.6k

项目参考Blog：[Koin使用](https://www.jianshu.com/p/4b819bd06bb8)
